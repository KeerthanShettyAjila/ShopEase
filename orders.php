...
<body>
    ...
    <div class="container-fluid pt-5" style="background-color: #f8f9fa; font-family: 'Arial', sans-serif;">
        <div class="row px-xl-5">
            <div class="col-lg-12">
                <?php
                $ordered_products_table = $admin->ret("SELECT * FROM `ordered_products` WHERE `u_id`='$u_id' ORDER BY `op_id` DESC");
                while ($ordered_products_row = $ordered_products_table->fetch(PDO::FETCH_ASSOC)) {
                    $op_id = $ordered_products_row['op_id'];
                    $status = $ordered_products_row['op_status'];
                    $username = $ordered_products_row['f_name']; //extra added
                ?>
                <div class="card shadow-lg border-0 mb-4 rounded-3" style="border-radius: 15px;">
                    ...
                    <div class="card-body" style="padding: 1.5rem;">
                        <div class="row customer-info mb-4" style="border-bottom: 1px solid #e0e0e0; padding-bottom: 1rem;">
                            <div class="col-md-4 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fa fa-user-circle" style="color: #007bff; font-size: 1.5rem; margin-right: 0.5rem;"></i>
                                    <div>
                                        <small class="text-muted d-block">Customer Name</small>
                                        <span class="fw-bold"><?php echo htmlspecialchars($ordered_products_row['f_name'] . ' ' . $ordered_products_row['l_name']); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fa fa-envelope" style="color: #6c757d; font-size: 1.5rem; margin-right: 0.5rem;"></i>
                                    <div>
                                        <small class="text-muted d-block">Email</small>
                                        <span class="fw-bold"><?php echo htmlspecialchars($ordered_products_row['email']); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-bold"><?php echo htmlspecialchars($ordered_products_row['num']); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fa fa-map-marker" style="color: red; font-size: 1.5rem; margin-right: 0.5rem;"></i>
                                    <div>
                                        <small class="text-muted d-block">Address</small>
                                        <span class="fw-bold"><?php echo htmlspecialchars($ordered_products_row['add1'] . ', ' . $ordered_products_row['add2'] . ', ' . $ordered_products_row['city'] . ', ' . $ordered_products_row['state'] . ' - ' . $ordered_products_row['zip']); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-bold">
                                            <?php 
                                            if ($ordered_products_row['payment'] == 'Online') {
                                                echo 'Transaction ID: ' . htmlspecialchars($ordered_products_row['transaction']);
                                            } else {
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover border" style="border-radius: 10px; overflow: hidden;">
                                ...
                                <tbody>
                                    <?php
                                        $oproduct_table = $admin->ret("SELECT * FROM `ordered_products` WHERE `op_id`='$op_id'");
                                        $total = 0;
    ...
    function renderCustomerInfo($ordered_products_row, $username)
    {
        return '
        ...
        <div class="col-md-3 mb-2">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <span class="fw-bold">' . htmlspecialchars($ordered_products_row['add1']) . '</span>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-2">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <span class="fw-bold">' . htmlspecialchars($ordered_products_row['num']) . '</span>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-2">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <span class="fw-bold">' . htmlspecialchars($ordered_products_row['transaction']) . '</span>
                </div>
            </div>
        </div>
    ';
