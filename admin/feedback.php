                                ...
                                <div class="card shadow-lg border-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            ...
                                            <span class="badge bg-light text-dark px-3 py-2"><?php echo $admin->ret("SELECT COUNT(*) FROM `feedback`")->fetchColumn(); ?> Entries</span>
                                        </div>
                                            ...
                                            <table class="table table-hover align-middle">
                                                <thead class="bg-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-dark fw-bold" width="15%">Vendor</th>
                                                        ...
                                                        <th class="text-dark fw-bold" width="35%">Feedback</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    $feedback_table = $admin->ret("SELECT feedback.*, product.*, vendor.v_name 
                                                                                FROM `feedback` 
                                                                                INNER JOIN `product` ON feedback.p_id = product.p_id 
                                                                                INNER JOIN `vendor` ON product.v_id = vendor.v_id 
                                                                                ORDER BY feedback.op_id DESC");
                                                    $index = 1;
                                                    ...
                                                    ?>
                                                        <tr class="border-bottom">
                                                            ...
                                                            <td>
                                                                <span class="badge bg-info text-white px-3 py-2"><?php echo $feedback_row['v_name']; ?></span>
                                                            </td>
                                                            <td>
