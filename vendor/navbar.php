<?php 
$v_id = $_SESSION['v_id'];
$vendor_table = $admin->ret("SELECT * FROM `vendor` WHERE `v_id`='$v_id'");
          ...
          <div class="main-header-logo">
            <div class="logo-header" data-background-color="dark2">
              <a href="index.html" class="logo">
                <img
                  src="controller/upload/img23.jpg"
                  alt="navbar brand"
                  class="navbar-brand"
                  height="28"
                />
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  <a class="dropdown-toggle profile-pic d-flex align-items-center" 
                    ...
                    <span class="profile-username">
                      ...
                      <span class="fw-bold text-dark"><?php echo $vendor_row['v_name']?></span>
                    </span>
                  </a>
                        ...
                        <div class="user-box p-4">
                          <div class="d-flex align-items-center">
                            ...
                            <div class="u-text" style="min-width: 200px;">
                              <h4 class="fw-bold mb-2"><?php echo $vendor_row['v_name']?></h4>
                              <div class="d-flex align-items-center text-muted mb-0">
                                <i class="fas fa-envelope me-2"></i>
                                <span class="text-truncate"><?php echo $vendor_row['v_email']?></span>
                              </div>
                            </div>
                          </div>
                        </div>
